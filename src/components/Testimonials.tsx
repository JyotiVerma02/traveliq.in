  ...
  return (
    <section id="testimonials" className="relative overflow-hidden border-b border-[#10407A]/10 bg-[#FFF8F3] py-12 sm:py-14 lg:py-16">
      ...
      <div className="pointer-events-none absolute inset-0 overflow-hidden">
        ...
        {/* Center soft light */}
        <div className="absolute left-1/2 top-1/2 h-[550px] w-[800px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-white/70 blur-[130px]" />

        {/* Small orange glow */}
        <div className="absolute left-[20%] top-[35%] h-32 w-32 rounded-full bg-[#EE5326]/[0.025] blur-3xl" />
      </div>
      ...
      <div className="relative mx-auto max-w-[1400px] px-4 sm:px-6 lg:px-10">
          ...
          {testimonials.map((testimonial, index) => (
            ...
            <article className="group relative flex min-h-[410px] flex-col justify-between overflow-hidden rounded-[30px] border border-[#10407A]/12 bg-[#FFF8F3] p-6 shadow-[10px_10px_24px_rgba(16,64,122,0.10),-8px_-8px_20px_rgba(255,255,255,0.96)] transition-all duration-500 hover:-translate-y-1.5 hover:border-[#10407A]/20 hover:shadow-[14px_14px_30px_rgba(16,64,122,0.13),-10px_-10px_24px_rgba(255,255,255,0.98)]">
              ...
              <div className="absolute right-0 top-0 h-20 w-20 overflow-hidden">
                <div className="absolute -right-10 -top-10 h-20 w-20 rotate-45 bg-[#EE5326] opacity-90 transition-all duration-500 group-hover:opacity-100" />
              </div>
                ...
                <div className="flex items-center justify-between gap-3">
                  ...
                  <div className="flex min-w-0 items-center gap-3">
                    ...
                    <div className="min-w-0">
                      <h3 className="truncate text-[13px] font-black text-[#0B1728]">
                        {testimonial.name}
                      </h3>

                      <p className="mt-1 text-[9px] font-black uppercase tracking-[0.14em] text-[#475569]">
                        {testimonial.role}
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="h-8 w-1 shrink-0 rounded-full bg-[#EE5326] opacity-70 transition-all duration-300 group-hover:h-10 group-hover:opacity-100" />
                </div>
              </div>
        ...
        <Reveal className="mt-10 flex flex-col gap-5 rounded-[22px] border border-[#10407A]/12 bg-[#FFF8F3] px-5 py-4 shadow-[6px_6px_14px_rgba(16,64,122,0.06),-5px_-5px_12px_rgba(255,255,255,0.95)] sm:flex-row sm:items-center sm:justify-between">
          ...
          <div className="flex items-center gap-3">
            <span className="flex h-8 w-8 shrink-0 items-center justify-center rounded-xl bg-[#10407A] text-xs font-black text-white shadow-[4px_4px_8px_rgba(16,64,122,0.12),-3px_-3px_7px_rgba(255,255,255,0.9)]">
              ✓
            </span>
          ...
          <div className="flex items-center gap-3 rounded-full bg-[#FFF0E9] px-4 py-2">
            <span className="h-1.5 w-1.5 rounded-full bg-[#EE5326]" />
